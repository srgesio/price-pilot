...
export const ResultBox = forwardRef<HTMLDivElement, ResultBoxProps>(
    ({ label, value, prefix = '', highlight = false, strong = false }, ref) => (
        <div
            ref={ref}
            className={`flex flex-col justify-center items-center p-4 sm:p-6 rounded-xl border-2 shadow-lg min-w-[120px] sm:min-w-[160px] max-w-[200px] h-[110px] sm:h-[130px] transition-all duration-200 border-[#0078d4]/30 bg-white/90 dark:bg-[#10131a]/80 relative result-box
                ${highlight
        ...
        >
            ...
            <span className="text-lg sm:text-2xl tabular-nums font-mono whitespace-nowrap overflow-hidden text-ellipsis max-w-full">
